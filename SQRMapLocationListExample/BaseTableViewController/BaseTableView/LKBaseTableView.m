...
- (UIImage *)imageForEmptyDataSet:(UIScrollView *)scrollView {
    ...
    switch (self.emptyImageType) {
        case Common:
            emptyImage = [UIImage imageNamed:@"ic_noticon"];
            break;
        case Goods:
            emptyImage = [UIImage imageNamed:@"icon_quesheng_HB"];
            break;
        case List:
            emptyImage = [UIImage imageNamed:@"ic_not_data"];
            break;
        case Shops:
            emptyImage = [UIImage imageNamed:@"icon_quesheng_PH"];
            break;
        case Message:
            emptyImage = [UIImage imageNamed:@"icon_quesheng_XX"];
            break;
        case Parcels:
            emptyImage = [UIImage imageNamed:@"icon_quesheng_YQ"];
            break;
...
- (NSAttributedString *)descriptionForEmptyDataSet:(UIScrollView *)scrollView {
    ...
    if (self.emptySubTipString && self.emptySubTipString.length > 0) {
        ...
        UIFont *font = self.emptyTipStringFont ? self.emptySubTipStringFont : [UIFont systemFontOfSize:13.f];
        UIColor *color = self.emptyTipStringColor ? self.emptySubTipStringColor : [UIColor grayColor];
